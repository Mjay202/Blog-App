...
export const getPost = (req, res) => {
  const q = "SELECT p.id, `uname`, `title`, `desc`, `cont`, p.img, `uid`, u.image AS userImg, `cat`, `date` FROM users u JOIN posts p ON u.id=p.uid WHERE p.id = ?"
...
export const addPost = (req, res) => {
   ...
   const q = "INSERT INTO posts (`title`, `desc`, `img`, `cat`, `date`, `cont`, `uid`) VALUES (?)";
